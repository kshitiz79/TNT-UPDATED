  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      const updatedFormData = {
        ...
        date: formData.bestDateToCall, // Assuming this is the "date" field
        course: formData.course,
        time: formData.preferredTime, // Assuming this is the "time" field
        timezone: formData.timeZone, // Use the timezone field
      };
      ...
      >
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value=" Azure Devops Architect">
